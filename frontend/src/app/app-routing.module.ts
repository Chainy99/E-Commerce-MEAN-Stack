...
const routes: Routes = [
  ...
  { path: 'admin/addmedicine', component: AddmedicineComponent, canActivate: [AdminGuard] },
  { path: 'admin/viewfeedback', component: ViewfeedbackComponent, canActivate: [AdminGuard] },
  { path: 'admin/viewmedicine', component: ViewmedicineComponent, canActivate: [AdminGuard] },
  { path: 'admin/editmedicine', component: EditmedicineComponent, canActivate: [AdminGuard] },
  ...
  { path: 'userdiscount', component: UserdiscountComponent, canActivate: [AuthGuard] },
